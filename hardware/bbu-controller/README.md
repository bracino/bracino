...
**J7** is a 2-pin **5 V-only** jumper: buck VO (`+5V_VO`) ↔ board +5 V. Jumper out isolates the buck even if 12 V is still on the inlet. Do not plug USB with J7 in. Mechanical USB-blocking holder not built yet.
