...
GPIO8 → D1 → R7 2.2 kΩ → GND (heartbeat). D2 / R8 4.7 kΩ is the 12 V power LED on post-Schottky buck VIN (USB must not light it). TFT LED: schematic **R3 220 Ω**; bench (2026-08-25) **100 Ω** is acceptably brighter — schematic not bumped yet.
