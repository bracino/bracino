...
| ESP-NOW payload schema | **Settled — wire law** — [DESIGN_NOTE_003](DESIGN_NOTE_003_espnow_node_schema.md) (2026-08-30; sample fixed to 12 B with `rsv` on 2026-08-31; `ct_state=NOT_FITTED` added 2026-09-01). Implemented in `node-bbu` (011) behind `comms_enabled`; 013 drills pending |
