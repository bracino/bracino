...
- [ ] Field install (012 — firmware field-image complete & bench-walked 2026-09-02; encoder WDT named 2026-09-03, A/B now polled; re-soak then remove `CONFIG_ESP_TASK_WDT_PANIC` for the field image; comms stays OFF until the logger exists)
