...
- [ ] Gateway still empty
- [ ] TFT + encoder breadboard (010): landscape 12×16 + ISR encoder in tree; needs a flash to confirm MADCTL and one-detent-per-step
...
- [ ] TFT + encoder: bench the landscape/ISR rewrite, then UI protoboard
